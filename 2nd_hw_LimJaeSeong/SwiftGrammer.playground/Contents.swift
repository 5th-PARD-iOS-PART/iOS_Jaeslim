...
func printArea(width: Float, height: Float) {
    print("\(width * height)")
}
...
func checkLoginStatus(isLoggined: Bool, username: String?) {
    if isLoggined {
